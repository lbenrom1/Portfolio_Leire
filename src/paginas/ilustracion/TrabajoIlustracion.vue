...
<template>
    ...
    <div class="bg-[#439c82]">
      ...
      hover-text-color="hover:text-[#439c82]"
      />
      ...
      <section id="presentación">
        ...
        <div class="  bg-[#439c82] w-full flex justify-center items-center min-h-[60vh] lg:min-h-[80vh]">
          <Carrus
           :photos="photos"
       ...
       <section id="proceso" class="bg-[#439c82] pt-10">
       ...
       <section id="bocetos" class="bg-[#439c82] pt-15">
      ...
      <div class="grid grid-cols-1 gap-4 p-10 lg:grid-cols-5 lg:grid-rows-3 lg:h-150 lg:px-30">
        ...
        <div class="col-span-3 row-span-3 bg-[#439c82] rounded-lg">
          <img
           v-if="finales.length"
